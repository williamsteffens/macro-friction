...
QT_FORWARD_DECLARE_CLASS(QOpenGLFunctions_4_3_Core)
...
#define QOpenGLFunctions QOpenGLFunctions_4_3_Core
...
{
public:
    explicit RigidBodyRenderer(QOpenGLFunctions* _gl, RigidBodySystem* _system);
...
private:
    ...
    ShaderVars m_depthShader;
    ShaderVars m_contactCoeffShader;
    ShaderVars m_contactWeightShader;
